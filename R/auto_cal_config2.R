    ...
    wave1 = list(
      job1 = list(
        ...
        initial_proposals = dplyr::tibble(
          prep.start.prob_1 = seq(0.00001, 0.001, length.out = n_sims),
        ),
      ...
      job2 = list(
        ...
        initial_proposals = dplyr::tibble(
          prep.start.prob_2 = seq(0.00001, 0.001, length.out = n_sims),
        ),
        make_next_proposals = make_shrink_proposer(n_sims),
        get_result = determ_poly_end(0.001, poly_n = 5)
      ),
      job3 = list(
        ...
        initial_proposals = dplyr::tibble(
          prep.start.prob_3 = seq(0.00001, 0.001, length.out = n_sims),
        ),
        make_next_proposals = make_shrink_proposer(n_sims),
        get_result = determ_poly_end(0.001, poly_n = 5)
      )
