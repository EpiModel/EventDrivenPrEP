...
calibration_end    <- 52 * 60 * 7
restart_time       <- calibration_end + 1*7
prep_start         <- restart_time + 52 * 5 * 7
intervention_start <- prep_start + 52 * 5 * 7
intervention_end   <- intervention_start + 52 * 10 * 7
