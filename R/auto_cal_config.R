...
calib_object <- list(
  ...
  config = list(
    ...
    default_proposal = dplyr::tibble(
      hiv.test.rate_1 = 0.000680975,
      hiv.test.rate_2 = 0.000596133,
      hiv.test.rate_3 = 0.000915131,
      tx.init.rate_1 = 0.042600143,
      tx.init.rate_2 = 0.052528857,
      tx.init.rate_3 = 0.051131543,
      ugc.prob = 0.01,
      rgc.prob = plogis(qlogis(ugc.prob) + log(1.25)),
      uct.prob = 0.01,
      rct.prob = plogis(qlogis(uct.prob) + log(1.25)),
      tx.halt.partial.rate_1 = 0.000719048,
      tx.halt.partial.rate_2 = 0.000667987,
      tx.halt.partial.rate_3 = 0.000447747,
